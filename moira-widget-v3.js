document.addEventListener("DOMContentLoaded", function() {
    ...
    const scriptTag = document.querySelector('script[src*="https://cdn.jsdelivr.net/gh/MoiraAI2024/widget@main/moira-widget-v3.js"]');
    // const scriptTag = document.querySelector('script[src*="http://localhost:8000/moira-widget-v3.js"]');
